    ...
    extend: {
      colors: {
        ...
        sidebar: {
          ...
          primary: "hsl(var(--sidebar-primary, 292 84% 61%))",
          "primary-foreground": "hsl(var(--sidebar-primary-foreground, 0 0% 100%))",
          accent: "hsl(var(--sidebar-accent, 240 6% 12%))",
          "accent-foreground": "hsl(var(--sidebar-accent-foreground, 0 0% 98%))",
          border: "hsl(var(--sidebar-border, 240 6% 15%))",
          ring: "hsl(var(--sidebar-ring, 292 84% 61%))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
